...
def get_google_places_data(restaurant_name, city_name):
    ...
    data = {"textQuery": f"{restaurant_name} in {city_name}"}
    ...
    if place_id:
        ...
        try:
            ...
            if ReviewSummary.objects.filter(
                ...
                last_updated__gte=timezone.now() - timedelta(days=28),
            ).exists():
            ...
            restaurant, created = Restaurant.objects.get_or_create(
                ...
                defaults={
                    ...
                    "city": city_name,
                    "display_name": place_details.get(
                        "displayName", f"{restaurant_name} in {city_name}"
                    ),
