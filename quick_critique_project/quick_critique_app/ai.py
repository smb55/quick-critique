ai_context = '''You are an assistant who analyses restaurant reviews and replies in detail, and
            ...
            form of a Python dictionary that includes various information about the review under different keys. Note that the
            "reviews" key is the number of reviews the reviewer has made - you might use this to lower the weight of the
            review in the case of very few reviews if it appears like it might be either fake or malicious.'
            ...
            If there is feedback that doesn't fit into a section, include it in the "*Summary:" section.'''
